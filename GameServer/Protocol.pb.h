...
class C_EXIT_GAME final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Protocol.C_EXIT_GAME) */ {
 public:
  ...
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const C_EXIT_GAME& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
...
class S_START_GAME final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.S_START_GAME) */ {
 public:
  inline S_START_GAME() : S_START_GAME(nullptr) {}
  ~S_START_GAME() override;
  explicit PROTOBUF_CONSTEXPR S_START_GAME(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S_START_GAME& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const S_START_GAME& from) {
    S_START_GAME::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S_START_GAME* other);
  ...
  void set_counttime(uint32_t value);
  private:
  uint32_t _internal_counttime() const;
  void _internal_set_counttime(uint32_t value);
  public:
...
class S_GAME_RESULT final :
 ...
 public:
  ...
  enum : int {
    kWinplayeridFieldNumber = 1,
  };
  // uint64 winplayerid = 1;
  void clear_winplayerid();
  uint64_t winplayerid() const;
  void set_winplayerid(uint64_t value);
  private:
  uint64_t _internal_winplayerid() const;
  void _internal_set_winplayerid(uint64_t value);
  public:
...
// uint32 needplayer = 2;
inline void S_ENTER_GAME::clear_needplayer() {
  _impl_.needplayer_ = 0u;
}
inline uint32_t S_ENTER_GAME::_internal_needplayer() const {
  return _impl_.needplayer_;
}
inline uint32_t S_ENTER_GAME::needplayer() const {
  // @@protoc_insertion_point(field_get:Protocol.S_ENTER_GAME.needplayer)
  return _internal_needplayer();
}
inline void S_ENTER_GAME::_internal_set_needplayer(uint32_t value) {
  
  _impl_.needplayer_ = value;
}
inline void S_ENTER_GAME::set_needplayer(uint32_t value) {
  _internal_set_needplayer(value);
  // @@protoc_insertion_point(field_set:Protocol.S_ENTER_GAME.needplayer)
}
...
// bool success = 1;
inline void S_START_GAME::clear_success() {
  _impl_.success_ = false;
}
inline bool S_START_GAME::_internal_success() const {
  return _impl_.success_;
}
inline bool S_START_GAME::success() const {
  // @@protoc_insertion_point(field_get:Protocol.S_START_GAME.success)
  return _internal_success();
}
inline void S_START_GAME::_internal_set_success(bool value) {
  
  _impl_.success_ = value;
}
inline void S_START_GAME::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:Protocol.S_START_GAME.success)
}

// uint32 counttime = 2;
inline void S_START_GAME::clear_counttime() {
  _impl_.counttime_ = 0u;
}
inline uint32_t S_START_GAME::_internal_counttime() const {
  return _impl_.counttime_;
}
inline uint32_t S_START_GAME::counttime() const {
  // @@protoc_insertion_point(field_get:Protocol.S_START_GAME.counttime)
  return _internal_counttime();
}
inline void S_START_GAME::_internal_set_counttime(uint32_t value) {
  
  _impl_.counttime_ = value;
}
inline void S_START_GAME::set_counttime(uint32_t value) {
  _internal_set_counttime(value);
  // @@protoc_insertion_point(field_set:Protocol.S_START_GAME.counttime)
}
...
// .Protocol.PlayerInfo player = 1;
inline bool S_SPAWN_PLAYER::_internal_has_player() const {
  return this != internal_default_instance() && _impl_.player_ != nullptr;
}
inline bool S_SPAWN_PLAYER::has_player() const {
  return _internal_has_player();
}
inline const ::Protocol::PlayerInfo& S_SPAWN_PLAYER::_internal_player() const {
...
inline const ::Protocol::PlayerInfo& S_SPAWN_PLAYER::player() const {
  // @@protoc_insertion_point(field_get:Protocol.S_SPAWN_PLAYER.player)
  return _internal_player();
}
inline void S_SPAWN_PLAYER::unsafe_arena_set_allocated_player(
    ::Protocol::PlayerInfo* player) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.S_SPAWN_PLAYER.player)
}
inline ::Protocol::PlayerInfo* S_SPAWN_PLAYER::release_player() {
...
inline ::Protocol::PlayerInfo* S_SPAWN_PLAYER::unsafe_arena_release_player() {
  // @@protoc_insertion_point(field_release:Protocol.S_SPAWN_PLAYER.player)
  
  ::Protocol::PlayerInfo* temp = _impl_.player_;
  _impl_.player_ = nullptr;
  return temp;
}
inline ::Protocol::PlayerInfo* S_SPAWN_PLAYER::_internal_mutable_player() {
...
inline ::Protocol::PlayerInfo* S_SPAWN_PLAYER::mutable_player() {
  ::Protocol::PlayerInfo* _msg = _internal_mutable_player();
  // @@protoc_insertion_point(field_mutable:Protocol.S_SPAWN_PLAYER.player)
  return _msg;
}
inline void S_SPAWN_PLAYER::set_allocated_player(::Protocol::PlayerInfo* player) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.player_);
  }
  ...
  _impl_.player_ = player;
  // @@protoc_insertion_point(field_set_allocated:Protocol.S_SPAWN_PLAYER.player)
}
...
// uint64 winplayerid = 1;
inline void S_GAME_RESULT::clear_winplayerid() {
  _impl_.winplayerid_ = uint64_t{0u};
}
inline uint64_t S_GAME_RESULT::_internal_winplayerid() const {
  return _impl_.winplayerid_;
}
inline uint64_t S_GAME_RESULT::winplayerid() const {
  // @@protoc_insertion_point(field_get:Protocol.S_GAME_RESULT.winplayerid)
  return _internal_winplayerid();
}
inline void S_GAME_RESULT::_internal_set_winplayerid(uint64_t value) {
  
  _impl_.winplayerid_ = value;
}
inline void S_GAME_RESULT::set_winplayerid(uint64_t value) {
  _internal_set_winplayerid(value);
  // @@protoc_insertion_point(field_set:Protocol.S_GAME_RESULT.winplayerid)
}
